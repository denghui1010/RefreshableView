 ...
 */
public class RefreshableExpandableListView extends ExpandableListView implements IRefreshable {
    ...
    public RefreshableExpandableListView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
