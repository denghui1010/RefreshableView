...
public class RefreshableRecyclerView extends RecyclerView implements IRefreshable {
    public static final String TAG = RefreshableRecyclerView.class.getSimpleName();
